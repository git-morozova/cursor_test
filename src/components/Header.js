    ...
    <>
      ...
      <header className={`header ${isScrolled ? 'scrolled' : ''}`}>
        <div className="header-container">
          <div className="logo">Остеопракт</div>
          <nav className={`nav ${isMenuOpen ? 'open' : ''}`}>
            <a href="#osteopraktika" onClick={(e) => { e.preventDefault(); scrollToSection('osteopraktika'); }}>Остеопрактика</a>
            <a href="#pricing" onClick={(e) => { e.preventDefault(); scrollToSection('pricing'); }}>Цены</a>
            <a href="#about-doctor" onClick={(e) => { e.preventDefault(); scrollToSection('about-doctor'); }}>Обо мне</a>
